...
const ProposalForm: React.FC<ProposalFormProps> = ({ isOpen, onClose, onSubmit, isSubmitting }) => {
    ...
    <div className="proposal-form__overlay">
      <div className="proposal-form__modal">
        ...
        <div className="proposal-form__field">
          ...
          <input id="proposal-title" type="text" placeholder="Give your proposal a clear title"
            value={title} onChange={(e) => setTitle(e.target.value)} />
        </div>
        <div className="proposal-form__field">
          <label htmlFor="proposal-intent">Intent</label>
          <textarea id="proposal-intent" placeholder="Explain why this change is needed"
            value={intent} onChange={(e) => setIntent(e.target.value)} />
        </div>
        <div className="proposal-form__field">
          <label htmlFor="proposal-scope">Scope</label>
          <textarea id="proposal-scope" placeholder="Describe what parts of the document are affected"
