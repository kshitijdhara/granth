...
const ProfilePage: React.FC = () => {
	...
	const bio =
		"This concise profile focuses on clarity and directness—only the most relevant information is shown here.";
				...
				<div className="profile-card">
					...
					<div className="profile-main">
						...
						<div className="profile-details">
							<div className="profile-email" title={`Email: ${email ?? "not provided"}`}>
